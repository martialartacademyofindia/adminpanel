        ...
        <div class="modal-dialog" style="width:800px;">
            <div class="modal-content">
                        ...
                        <div class="box-body">
                            <div class=" col-md-12">
                                ...
                                <div class="model-course-help">
                                    ...
                                    <div class="col-sm-9">
                                        <select onchange="get_belt_details_from_course('a_sc_co_id','a_sc_be_id');" required id="a_sc_co_id" name="a_sc_co_id" class="form-control">
                                            <option value="0">--Please select--</option>
                                            <?php
                                            $data_arr_input = array();
                                ...
                                <div class="model-course-help">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" readonly name="a_sc_joined_date" id="a_sc_joined_date"  placeholder="Joining Date" value="<?php echo DBtoDisp($cur_date); ?>" class="form-control" />
                                    </div>
                                </div>
                                <div class="model-course-help">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="add_course_to_student_ajax();" class="btn btn-primary confirm-class">Add Course</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
        ...
        function delete_student_course(in_sc_id)
        {
            ...
            if (ans == true)
            {
                $.ajax({
                    type: "POST",
                    url: "ajax.php",
                    data: {action: "remove-student-existing-course-details", sc_id: in_sc_id},
    ...
    // this function will get student course details
        function get_student_coures_data(stu_id)
        {
            ...
            $.ajax({
                type: "POST",
                url: "ajax.php",
                data: {action: "get-student-existing-course-details", stu_id: stu_id},
                success: function (result) {
                    result = $.trim(result);
        ...
        function add_course_to_student_ajax()
        {
            ...
            // $('#a_process_'+ei_id).remove();
            if ($("#a_sc_be_id").val() == 0 || $("#a_sc_co_id").val() == 0 || $("#a_sc_brt_id").val() == 0 || $("#a_stu_id").val() == 0)
            {
       ...
       //     alert($("#sc_half_course"). prop("checked")); return false;
            ...
            $.ajax({
                type: "POST",
                url: "ajax.php",
                data: {action: "add_course_to_student_ajax", a_sc_be_id: $("#a_sc_be_id").val(), a_sc_co_id: $("#a_sc_co_id").val(), a_sc_brt_id: $("#a_sc_brt_id").val(), a_stu_id: $("#a_stu_id").val(), a_sc_joined_date: $("#a_sc_joined_date").val(), sc_course_type: $("#sc_course_type").val(),a_sc_half_course: a_sc_half_course},
                success: function (result) {
                    result = $.trim(result);
...
<?php } else if ($c_file == 'student_fees.php') {
    ...
    <div class="modal" id="pay_fee_student" >
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">Pay Fees  [<span id="d_student_name"></span>] <a href="javascript:void(0);" onclick="fresh_receipt();">New</a></h4>
                </div>
                <div class="modal-body">
                    <!-- start of showing details -->
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class=" col-md-12">
                                ...
                                <div class="model-course-help">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" required id="pt_tran_amount" name="pt_tran_amount" class="form-control" />
                                    </div>
                                </div>
                                <div class="model-course-help">
                                    <label class="col-sm-3 control-label">Discount</label>
                                    <div class="col-sm-9">
                                        <input type="text" required id="pt_discount_amount" name="pt_discount_amount" class="form-control" />
                                    </div>
                                </div>
                                <div class="model-course-help">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
                    <button type="button" onclick="pay_fee_student_ajax();" class="btn btn-primary confirm-class">Pay Fee</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
    ...
    // this function will get student course fees details
        function get_student_fees_payment_details(in_sc_id)
        {
            ...
            $.ajax({
                type: "POST",
                url: "ajax.php",
                data: {action: "get-student-fees-payment-details", sc_id: in_sc_id},
                success: function (result) {
                    result = $.trim(result);
        ...
        function get_student_fees_payment_details_for_edit(in_type,in_pt_id,in_pt_sc_id)
        {
            $.ajax({
                type: "POST",
                url: "ajax.php",
                data: {action: "get-student-fees-payment-details-for-edit", pt_id: in_pt_id,pt_sc_id: in_pt_sc_id,type:in_type},
                success: function (result) {
                    result = $.trim(result);
        ...
        function pay_fee_student(d_stu_id, d_sc_id, d_sc_br_id, d_sc_brt_id, d_sc_co_id, d_sc_be_id, d_title, amt_topay, amt_paid, d_student_name,d_amt_discount)
        {
        ...
        function pay_fee_student_ajax()
        {
            ...
            if ( ($("#pt_id").val() == '' || $("#pt_id").val()==0) && parseInt($("#pt_tran_amount").val()) > d_max_pending_pay)
            {
            ...
            $.ajax({
                type: "POST",
                url: "ajax.php",
                data: {action: "pay_fee_student_ajax", pt_id:$("#pt_id").val(), pt_receipt_no: $("#pt_receipt_no").val(), pt_tran_bank: $("#pt_tran_bank").val(), pt_tran_no: $("#pt_tran_no").val(), pt_tran_mode_of_payent: $("#pt_tran_mode_of_payent").val(), pt_tran_bank : $("#pt_tran_bank").val(), pt_tran_amount: $("#pt_tran_amount").val(), pt_tran_date: $("#pt_tran_date").val(), pt_tran_remarks: $("#pt_tran_remarks").val(), d_stu_id: $("#d_stu_id").val(), d_sc_id: $("#d_sc_id").val(), d_sc_br_id: $("#d_sc_br_id").val(), d_sc_brt_id: $("#d_sc_brt_id").val(), d_sc_co_id: $("#d_sc_co_id").val(), d_sc_be_id: $("#d_sc_be_id").val(), pt_discount_amount: $("#pt_discount_amount").val()},  
                success: function (result) {
                    result = $.trim(result);
    ...
    <style>
   #pay_fee_student .modal-dialog  { width:700px; }
    </style>
    <!-- END - called in list of student page for enrollment of course details to student -->
...
<!-- end of code -->
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
                <button type="button" onclick="pay_fee_student_exam_ajax();" class="btn btn-primary confirm-class">Pay Exam Fee</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
