                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th align="center" class="t_align_center" width="330px">Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            ...
                                            if ($objData) {
                                                for ($i = 1; $db_row = $objData->fetch(); $i++) {
                                                    ...
                                                    <tr class="<?php echo $class; ?>">
                                                        ...
                                                        <td style="padding-left:10px;"><?php echo ($db_row['ex_status']=='A'?'Active':'Inactive'); ?></td>
                                                        <td>
                                                        <a href="exam_student_entrolled_print.php?ex_id=<?php echo $db_row['ex_id']; ?>" class="text-info fa fa-fw fa-print"></a>&nbsp;
                                                          <a href="exam_student_entrolled.php?enroll=1&ex_id=<?php echo $db_row['ex_id']; ?>" class="text-info">Enrollment</a>&nbsp;
                                                          <a href="exam_student_entrolled.php?pay_fee=1&ex_id=<?php echo $db_row['ex_id']; ?>" class="text-success">Pay Fee</a>&nbsp;
                                                          <a href="exam_student_entrolled.php?addresult=1&ex_id=<?php echo $db_row['ex_id']; ?>" class="text-danger">Result</a>&nbsp;
                                                          <a href="exam_student_entrolled.php?addcertificate=1&ex_id=<?php echo $db_row['ex_id']; ?>" class="text-warning">Certificate</a>&nbsp;
                                                          <a href="add_edit_exam.php?id=<?php echo $db_row['ex_id']; ?>&per_page=<?php echo $per_page; ?>" class="text-success glyphicon glyphicon-pencil" ></a>&nbsp;
                                                          <?php if ($db_row['count_exam'] == 0) { ?>
                                                          <a href="javascript:void(0);" data-toggle="modal" data-target="#ConfirmDelete" class="text-danger glyphicon glyphicon-remove" onclick="delete_record(<?php echo $db_row['ex_id']; ?>,'Exam')"></a>&nbsp;
                                                        <?php }  ?>
                                                        </td>
                                                    </tr>
                                                    <?php
