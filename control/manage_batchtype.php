...
if ($act == 'delete' && $id != 0) {
  if ($errormsg == '') {
     $arr_check_delete = validate_before_delete("sm_student_course", "sc_br_id = ".$tmp_admin_id.  " AND sc_brt_id = " . $id);
     if ($arr_check_delete["error_message"] != '') {
         $errormsg = $arr_check_delete["error_message"];
     } else if ($arr_check_delete["found_reference"] == true) {
         $errormsg = "Delete process can not be completed because of batch type is already used in student course";
     }
  }
                            ...
                            <div class="box box-info">
                                ...
                                <form class="form-horizontal" name="form1" id="form1" method="post" onsubmit="return validate_add_edit_form();">
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <button type="button" class="btn btn-default" onclick="window.location.href = 'manage_batchtype.php'">Cancel</button>
                                    </div><!-- /.box-footer -->
                                </form>
                            </div>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th align="center"><a href="manage_batchtype.php?page=<?php echo $page; ?>&per_page=<?php echo $per_page; ?>&order_by=brt_name&order=<?php echo $order; ?>">Branch Type Name <span class="<?php echo $brt_name_arrow; ?>"></span></a></th>
                                                <th align="center" width="80px">Days</th>
                                                <th align="center" width="80px">Amount</th>
                                                <th align="center" width="160px">Month Amount</th>
                                            ...
                                            if ($objData) {
                                                for ($i = 1; $db_row = $objData->fetch(); $i++) {
                                                    ...
                                                    <tr class="<?php echo $class; ?>">
                                                        ...
                                                        <td style="padding-left:10px;"><?php echo $db_row['brt_days']; ?></td>
                                                        <td style="padding-left:10px;"><?php echo $db_row['brt_amount']; ?></td>
                                                        <td style="padding-left:10px;"><?php echo $db_row['brt_amount_month']; ?></td>
                                                        <td style="padding-left:10px;"><?php echo ($db_row['brt_status']=='A'?'Active':'Inactive'); ?></td>
                                                        <td><center><a href="add_edit_batchtype.php?id=<?php echo $db_row['brt_id']; ?>&per_page=<?php echo $per_page; ?>" class="text-success glyphicon glyphicon-pencil" ></a>&nbsp;
