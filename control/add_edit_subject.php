                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="box box-info">
                                ...
                                <!-- form start -->
                                <form name="form1" id="form1" method="post" class="form-horizontal" onsubmit="return validate_add_edit_form();">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input required type="text" name="sub_name" id="sub_name"  placeholder="Subject Name" value="<?php echo $sub_name; ?>" class="form-control required" />
                                            </div>
                                        </div>
