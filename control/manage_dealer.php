...
$msg = get_rdata('msg', '');
if (isset($msg) && $msg == 1) {
    $successmsg = "Dealer Has Been Deleted Successfully";
} else if (isset($msg) && $msg == 2) {
    $successmsg = "Dealer Has Been Added Successfully";
} else if (isset($msg) && $msg == 3) {
    $successmsg = "Dealer Has Been Updated Successfully";
} else if (isset($msg) && $msg == 4) {
    $successmsg = "Dealer has been added successfully but course has not assigned to him/her";
} else if (isset($msg) && $msg == 5) {
      $successmsg = "Dealer has been added successfully and course has assigned to him/her";
} else {
    $successmsg = '';
}
...
if ($act == 'delete' && $id != 0) 
{
    if (check_dealer_invoice($id) == true) 
    {
                        ...
                        <div class="col-lg-12 col-xs-12">
                 		...
                 		<input type="hidden" value="0" name="id" id="id">
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <button type="button" class="btn btn-default" onclick="window.location.href = 'manage_dealer.php'">Cancel</button>
                                    </div><!-- /.box-footer -->
                                </form>
                            </div>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th align="center" ><a href="manage_dealer.php?page=<?php echo $page; ?>&per_page=<?php echo $per_page; ?>&order_by=del_company_name&order=<?php echo $order; ?>">Gr No. <span class="<?php echo $del_company_name_arrow; ?>"></span></a></th>
                                                <th align="center"><a href="manage_dealer.php?page=<?php echo $page; ?>&per_page=<?php echo $per_page; ?>&order_by=del_first_name&order=<?php echo $order; ?>">Name <span class="<?php echo $del_first_name_arrow; ?>"></span></a></th>
                                            ...
                                            if ($objData) {
                                                for ($i = 1; $db_row = $objData->fetch(); $i++) {
                                                    ...
                                                    <tr class="<?php echo $class; ?>">
                                                        ...
                                                        <td><center><a href="add_edit_dealer.php?id=<?php echo $db_row['del_id']; ?>&per_page=<?php echo $per_page; ?>" class="text-success glyphicon glyphicon-pencil" ></a>&nbsp;
                                                          <a href="javascript:void(0);" data-toggle="modal" data-target="#ConfirmDelete" class="text-danger glyphicon glyphicon-remove" onclick="delete_record(<?php echo $db_row['del_id']; ?>,'Dealer')"></a>&nbsp;<a href="manage_purchase.php?inv_purchase_del_id=<?php echo $db_row['del_id']; ?>" class="fa fa-shopping-cart" ></a></center></td>
