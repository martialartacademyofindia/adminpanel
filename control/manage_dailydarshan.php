...
//print_r($_REQUEST);
//set Page Title
$page_title = "Manage Daily Darshan";
...
$msg = get_rdata('msg', '');
if (isset($msg) && $msg == 1) {
    $successmsg = "Daily Darshan Has Been Deleted Successfully";
} else if (isset($msg) && $msg == 2) {
    $successmsg = "Daily Darshan Has Been Added Successfully";
} else if (isset($msg) && $msg == 3) {
    $successmsg = "Daily Darshan Has Been Updated Successfully";
} else {
    $successmsg = '';
}
...
$table = "sm_dailydarshan INNER JOIN sm_school_master ON (sc_id=ga_sc_id)";
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Manage Daily Darshan</li>
                    </ol>
                </section>
                        ...
                        <div class="col-lg-12 col-xs-12">
                 		...
                 		<input type="hidden" value="0" name="id" id="id">
                                    <div class="box-body">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Daily Darshan Name</label>
                                                <div class="col-sm-9">
                                                    <input type="text" name="ga_title" id="ga_title"  placeholder="Enter Daily Darshan Name" value="<?php echo $ga_title; ?>" class="form-control" />
                                                </div>
                                            </div>
                                        </div>                                                                             
                                    </div><!-- /.box-body -->
                                    <div class="box-footer">                                        
                                        ...
                                        <button type="button" class="btn btn-default" onclick="window.location.href = 'manage_dailydarshan.php'">Cancel</button>
                                    </div><!-- /.box-footer -->
                                </form>                                
                            </div>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th align="center"><a href="manage_dailydarshan.php?page=<?php echo $page; ?>&per_page=<?php echo $per_page; ?>&order_by=ga_title&order=<?php echo $order; ?>">Daily Darshan Name <span class="<?php echo $ga_title_arrow; ?>"></span></a></th>
                                            ...
                                            if ($objData) {
                                                for ($i = 1; $db_row = $objData->fetch(); $i++) {
                                                    ...
                                                    <tr class="<?php echo $class; ?>">
                                                        ...
                                                        <td><center><a href="add_edit_dailydarshan.php?id=<?php echo $db_row['ga_id']; ?>&per_page=<?php echo $per_page; ?>" class="edit glyphicon glyphicon-pencil" ></a>&nbsp;
                                                                <a href="javascript:void(0);" data-toggle="modal" data-target="#ConfirmDelete" class="delete glyphicon glyphicon-remove" onclick="delete_record(<?php echo $db_row['ga_id']; ?>,'Daily Darshan')"></a></center></td>
                                                    </tr>
                                                    <?php
                                                }
                                            } else {
