    ...
    // this function will get student course details
       ...
       //     alert($("#sc_half_course"). prop("checked")); return false;
            ...
            $.ajax({
                type: "POST",
                url: "ajax.php",
                data: {action: "add_course_to_student_ajax", a_sc_be_id: $("#a_sc_be_id").val(), a_sc_co_id: $("#a_sc_co_id").val(), a_sc_brt_id: $("#a_sc_brt_id").val(), a_stu_id: $("#a_stu_id").val(), a_sc_joined_date: $("#a_sc_joined_date").val(),a_sc_half_course: a_sc_half_course},
                success: function (result) {
                    result = $.trim(result);
