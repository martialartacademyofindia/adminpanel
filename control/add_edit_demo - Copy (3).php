                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="box box-info">
                                ...
                                <!-- form start -->
                                <form name="frmAddEditUser" id="frmAddEditUser" method="post" class="form-horizontal" onsubmit="return validate_user();">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="radio" name="sub_status" id="sub_status_a" <?php if ($sub_status == 'A') {  echo 'checked="checked"'; }; ?>  value="A" /><lable for="sub_status_a">Active</lable> <input type="radio" name="sub_status" id="sub_status_i" value="I" <?php if ($sub_status == 'I') echo 'checked="checked"'; ?> /><lable for="sub_status_i">InActive</lable>
                                            </div>
                            ...
                            <div class="box-footer">
                                            <input type="reset" value="Rest" class="btn btn-default" id="btnResetUser" name="btnResetUser" />
                                            <button type="submit" class="btn btn-info pull-right" id="btnAddUser" name="btnAddUser"><?php echo $caption; ?></button>
                                        </div><!-- /.box-footer -->
                            </form>
