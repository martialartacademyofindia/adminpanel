...
{
    $mfinalquery = "SELECT $select FROM $table WHERE ".$condition;
    $data_header= array("Sr.","Category","Product","Size","Color","Price","Qty","Sold","Dead","Net Qty");
    export_data("Report Stock","report_stock",$data_header,$mfinalquery);
    exit(0);
}
                                        ...
                                        <table  class="table table-bordered table-hover table-condensed"  id="print_me">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width="20%" class="text-left">Size</th>
